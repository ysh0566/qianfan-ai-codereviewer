...
const QIANFAN_AK: string = core.getInput("QIANFAN_AK");
const QIANFAN_SK: string = core.getInput("QIANFAN_SK");
const QIANFAN_MODEL: string = core.getInput("QIANFAN_MODEL");
